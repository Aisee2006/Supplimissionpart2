...
var packageBody,ground,base,zombieIMG,zombieSprite,invisibleBase;
...
function setup() {
    ...
    zombieSprite=createSprite(90,550,20,130);
	zombieSprite.addImage(zombieIMG)
	zombieSprite.scale=0.7;
	...
	//invisible base
	invisibleBase = Bodies.rectangle(width/2, 630, width, 10 , {isStatic:true} );
	World.add(world, invisibleBase);
